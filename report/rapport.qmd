...
Les livrables attendus sont un pipeline complet de Data Science, un modèle prédictif performant (RandomForest R²=0.73), un CNN TensorFlow (accuracy 52.5%) et un dashboard interactif d'aide à la décision.]
