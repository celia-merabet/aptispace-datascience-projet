...
2. **Visualisation & Analyse Exploratoire (EDA) (Chapitres 3 & 4) :**
* Création de graphiques multidimensionnels percutants pour mettre en évidence les insights majeurs de vos données (Matplotlib, Seaborn, Plotly).
* Statistiques descriptives univariées/bivariées et analyse statistique approfondie des corrélations et anomalies.

**🛑 LIVRABLE JALON 1 :** Un premier rapport justifiant vos choix de préparation de la donnée et présentant un résumé visuel des 3 à 5 insights majeurs découverts.
...
**🛑 LIVRABLE JALON 2 :** Le dossier dossier finalisé, intégrant les retours du Jalon 1 et la nouvelle partie prédictive.
